...
const (
	...
	StructType_closure  StructType = 8  //延迟函数，会作为参数传递给执行函数，由执行函数选择性执行【传参前不执行】
	StructType_block    StructType = 9  //代码块，本质是一系列函数逻辑组合 使用者可以定义一些通用的代码块方便后续复用
	StructType_return   StructType = 10 //reture类型，在sequence函数顺序执行过程中，如果表达式返回return类型将终止后续流程，直接返回reture类型中的结果
)
...
var file_lithengine_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x6c, 0x69, 0x74, 0x68, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x22, 0xa8,
	...
	0x72, 0x67, 0x73, 0x12, 0x2a, 0x0a, 0x06, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x18, 0x10, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x69, 0x74, 0x68, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65,
	0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x06, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x1a,
	0x4b, 0x0a, 0x09, 0x48, 0x61, 0x73, 0x68, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03,
	...
	0x6c, 0x69, 0x74, 0x68, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63,
	0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4b, 0x0a, 0x09,
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x69, 0x74,
	0x68, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe0, 0x01, 0x0a, 0x0e, 0x46, 0x75,
	0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x0e, 0x0a, 0x02,
	...
	,
	...
	0x04, 0x12, 0x08, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x10, 0x05, 0x12, 0x08, 0x0a, 0x04, 0x68,
	0x61, 0x73, 0x68, 0x10, 0x06, 0x12, 0x0c, 0x0a, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x10, 0x07, 0x12, 0x0b, 0x0a, 0x07, 0x63, 0x6c, 0x6f, 0x73, 0x75, 0x72, 0x65, 0x10, 0x08,
	0x12, 0x09, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x10, 0x09, 0x12, 0x0a, 0x0a, 0x06, 0x72,
	0x65, 0x74, 0x75, 0x72, 0x6e, 0x10, 0x0a, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_lithengine_proto_depIdxs = []int32{
	...
	1,  // 6: lithengine.FunctionSchema.input:type_name -> lithengine.Struct
	1,  // 7: lithengine.FunctionSchema.output:type_name -> lithengine.Struct
	1,  // 8: lithengine.Struct.HashEntry.value:type_name -> lithengine.Struct
